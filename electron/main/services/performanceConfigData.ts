...
const SqookyTesting: PerformancePreset = {
    ...
    convars: [
        ...
        ['citadel_camera_soft_collision_angle', '360'],
        ['r_citadel_clip_sphere_min_opacity', '0'],
        ['citadel_camera_pitch_max', '3600'],
        ['citadel_camera_pitch_min', '-3600'],
        ['r_texture_budget_threshold', '0.7'],
        ['r_texture_budget_update_period', '0.5'],
        ['r_texture_stream_mip_bias', '3'],
        ['r_texturefilteringquality', '0'],
...
const KaizuMinSpec: PerformancePreset = {
    ...
    sectionOps: [
        ...
        { path: ['GameInfo'], key: 'PGIVersion', remove: true },
        { path: ['SceneSystem'], key: 'CSMCascadeResolution', value: '0' },
        { path: ['SceneSystem'], key: 'CubemapFog', value: '0' },
        { path: ['SceneSystem'], key: 'DefaultShadowTextureHeight', value: '0' },
        { path: ['SceneSystem'], key: 'DefaultShadowTextureWidth', value: '0' },
...
/** UI labels for the opt-in groups are i18n keys; this maps group -> key. */
export const OPT_IN_GROUPS: Record<OptInGroup, string> = {
    visibility: 'Enemy and unit visibility',
    camera: 'Camera and field of view',
    devtools: 'Developer and testing tools',
};
